...
import { FileText, Download, TrendingUp, TrendingDown, BarChart3, PieChart, Calendar, Plus, Loader2, Trash2 } from "lucide-react";
...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .logo span { color: #64748b; font-weight: normal; }
    .doc-info { float: right; text-align: right; font-size: 12px; color: #64748b; }
    .title { font-size: 28px; font-weight: bold; color: #1e293b; margin-top: 10px; }
    .subtitle { font-size: 16px; color: #64748b; margin-top: 5px; }
    .meta { display: grid; grid-template-columns: repeat(2, 1fr); gap: 20px; margin: 30px 0; background: #f8fafc; padding: 20px; border-radius: 8px; }
    ...
    .section-title { font-size: 16px; font-weight: 600; color: #1e293b; border-bottom: 1px solid #e2e8f0; padding-bottom: 10px; margin-bottom: 15px; }
    ...
    .sig { margin-top: 60px; display: grid; grid-template-columns: repeat(2, 1fr); gap: 40px; }
    .sig-line { border-top: 1px solid #1e293b; padding-top: 10px; font-size: 12px; color: #64748b; }
  </style>
</head>
<body>
  <div class="header">
    ...
    <div class="logo">Apna CA <span>AI</span></div>
    <div class="title">${report.title}</div>
    <div class="subtitle">${report.report_type}</div>
  </div>
  <div class="meta">
    <div><div class="meta-label">Report Type</div><div class="meta-value">${report.report_type}</div></div>
    <div><div class="meta-label">Period</div><div class="meta-value">${report.period || 'N/A'}</div></div>
    <div><div class="meta-label">Generated On</div><div class="meta-value">${currentDate}</div></div>
    <div><div class="meta-label">File Size</div><div class="meta-value">${report.file_size || 'N/A'}</div></div>
  </div>
  <div class="section">
    <div class="section-title">Report Summary</div>
    <p>${report.description || 'This report was generated by Apna CA AI system.'}</p>
  </div>
  <div class="section">
    <div class="section-title">Details</div>
    <p>This ${report.report_type} report has been prepared in accordance with applicable Indian tax laws and accounting standards. Please review all figures and consult with your CA before filing.</p>
  </div>
  <div class="sig">
    <div><div class="sig-line">Prepared By</div></div>
    <div><div class="sig-line">Reviewed & Approved By</div></div>
  </div>
  <div class="footer">
    <div>This is a computer-generated document from Apna CA AI</div>
    <div>Page 1 of 1</div>
  </div>
</body>
</html>`;
...
export default function ReportsPage() {
  ...
  const handleDelete = async (report: Report) => {
    ...
    if (error) {
      ...
      await logActivity("delete", "report", report.id, { name: report.title });
    }
  };
